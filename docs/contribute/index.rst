...
applications. Both topics are grouped here together because the plugin-based architecture makes it quite similar. This
is our way to create a limit-less system: whatever can be done in the core system can be done in a userland application.
