...
from harp.apps.dashboard.utils.dates import (
    _truncate_datetime_for_time_bucket,
    generate_continuous_time_range,
    get_start_datetime_from_range,
)
from harp.protocols.storage import TransactionsGroupedByTimeBucket
...
def test_generate_continuous_time_range():
    ...
    time_bucket = "hour"
    with patch("harp.apps.dashboard.utils.dates.datetime") as mock_datetime:
