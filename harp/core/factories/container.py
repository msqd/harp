...
def create_container(config):
    ...
    if storage.type == "memory":
        from harp.services.old_deprecated_storage.in_memory import InMemoryStorage, InMemoryStorageSettings
        ...
        from harp.services.old_deprecated_storage.sql_database import SqlDatabaseStorage, SqlDatabaseStorageSettings
