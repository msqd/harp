...
ALL_BREAK_ON_VALUES = {BREAK_ON_HTTP_4xx, BREAK_ON_HTTP_5xx, BREAK_ON_NETWORK_ERROR, BREAK_ON_UNHANDLED_EXCEPTION}
...
NETWORK_ERRORS = {
    httpcore.NetworkError: (ERR_UNAVAILABLE_STATUS_CODE, ERR_UNAVAILABLE_MESSAGE, ERR_UNAVAILABLE_VERBOSE),
    httpx.NetworkError: (ERR_UNAVAILABLE_STATUS_CODE, ERR_UNAVAILABLE_MESSAGE, ERR_UNAVAILABLE_VERBOSE),
    httpcore.TimeoutException: (ERR_TIMEOUT_STATUS_CODE, ERR_TIMEOUT_MESSAGE, ERR_TIMEOUT_VERBOSE_MESSAGE),
    httpx.TimeoutException: (ERR_TIMEOUT_STATUS_CODE, ERR_TIMEOUT_MESSAGE, ERR_TIMEOUT_VERBOSE_MESSAGE),
    httpcore.RemoteProtocolError: (ERR_REMOTE_STATUS_CODE, ERR_REMOTE_MESSAGE, ERR_REMOTE_VERBOSE_MESSAGE),
    httpx.RemoteProtocolError: (ERR_REMOTE_STATUS_CODE, ERR_REMOTE_MESSAGE, ERR_REMOTE_VERBOSE_MESSAGE),
    SSLCertVerificationError: (ERR_SSL_STATUS_CODE, ERR_SSL_MESSAGE, ERR_SSL_VERBOSE_MESSAGE),
}
